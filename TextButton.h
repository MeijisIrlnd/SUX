...
namespace SUX
{
    ...
    public:
         ...
         */
        explicit TextButton(const std::string& text, const juce::Colour& colour = juce::Colour(0x00000000),
                            const juce::Colour& textColour = juce::Colour(0x00000000)) : m_textColour(textColour),
            m_text(text), m_originalColour(colour),
            m_colour(colour)
        {
        ...
        TextButton(const TextButton& other) : m_textColour(other.m_textColour), m_text(other.m_text),
                                              m_listener(other.m_listener), m_originalColour(other.m_originalColour),
        ...
        TextButton(TextButton&& other) noexcept : m_textColour(other.m_textColour), m_text(other.m_text),
                                                  m_listener(other.m_listener),
                                                  m_originalColour(other.m_originalColour), m_colour(other.m_colour)
        {
            if (m_textColour.getARGB() != 0)
            {
                m_label.setColour(juce::Label::ColourIds::textColourId, m_textColour);
